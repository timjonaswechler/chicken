...
use crate::i_overlay::bind::segment::{ContourIndex, IdSegment};
use crate::i_overlay::bind::solver::{JoinHoles, LeftBottomSegment};
use crate::i_overlay::core::graph::{OverlayGraph, OverlayNode};
use crate::i_overlay::core::link::OverlayLink;
use crate::i_overlay::core::link::OverlayLinkFilter;
use crate::i_overlay::core::nearest_vector::NearestVector;
...
use crate::i_shape::int::path::ContourExtension;
use crate::i_shape::int::shape::{IntContour, IntShapes};
use crate::i_shape::int::simple::Simplify;
use alloc::vec;
use alloc::vec::Vec;
...
mod tests {
    ...
    use crate::i_overlay::core::overlay::{ContourDirection, Overlay};
