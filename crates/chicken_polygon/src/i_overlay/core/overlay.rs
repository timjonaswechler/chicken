...
use crate::i_overlay::core::extract::BooleanExtractionBuffer;
...
use crate::i_overlay::vector::edge::{VectorEdge, VectorShape};
...
mod tests {
    ...
    use crate::i_overlay::core::overlay_rule::OverlayRule;
    use crate::i_shape::int::area::Area;
    use crate::i_shape::int::shape::IntContour;
    use alloc::vec;
