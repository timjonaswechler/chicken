...
use crate::i_overlay::core::overlay::ContourDirection::Clockwise;
use crate::i_overlay::core::overlay::{IntOverlayOptions, Overlay, ShapeType};
...
mod tests {
    ...
    use crate::i_overlay::core::simplify::vec;
