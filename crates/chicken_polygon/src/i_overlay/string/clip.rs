...
use crate::i_overlay::segm::string::{STRING_BACK_CLIP, STRING_FORWARD_CLIP};
...
use crate::i_shape::int::shape::{IntShape, IntShapes};
use alloc::vec::Vec;
...
mod tests {
    use crate::i_float::int::point::IntPoint;
    use crate::i_overlay::core::fill_rule::FillRule;
    use crate::i_overlay::string::clip::{ClipRule, IntClip};
    use crate::i_shape::int::path::IntPath;
    use alloc::vec;
