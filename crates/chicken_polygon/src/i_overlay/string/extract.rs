use crate::i_overlay::bind::solver::JoinHoles;
use crate::i_overlay::core::nearest_vector::NearestVector;
use crate::i_overlay::core::overlay::{ContourDirection, IntOverlayOptions};
use crate::i_overlay::segm::segment::SUBJ_TOP;
use crate::i_overlay::string::graph::StringGraph;
use crate::i_overlay::string::rule::StringRule;
use crate::i_overlay::string::split::{BinStore, Split};
use crate::i_shape::int::path::{ContourExtension, IntPath};
use crate::i_shape::int::shape::IntShapes;
use alloc::vec;
use alloc::vec::Vec;
...
mod tests {
    ...
    use crate::i_overlay::string::overlay::StringOverlay;
    use crate::i_overlay::string::rule::StringRule;
    use alloc::vec;
