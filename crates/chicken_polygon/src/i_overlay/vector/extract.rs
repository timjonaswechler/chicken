...
use crate::i_overlay::bind::segment::{ContourIndex, IdSegment, IdSegments};
use crate::i_overlay::bind::solver::{ShapeBinder, SortByAngle};
use crate::i_overlay::core::extract::{
    BooleanExtractionBuffer, GraphContour, GraphUtil, Visit, VisitState,
};
use crate::i_overlay::core::graph::OverlayGraph;
use crate::i_overlay::core::link::{OverlayLink, OverlayLinkFilter};
use crate::i_overlay::core::overlay::ContourDirection;
use crate::i_overlay::core::overlay_rule::OverlayRule;
use crate::i_overlay::geom::v_segment::VSegment;
use crate::i_overlay::segm::segment::SegmentFill;
use crate::i_overlay::vector::edge::{VectorEdge, VectorPath, VectorShape};
use crate::i_overlay::vector::simplify::VectorSimplify;
use alloc::vec;
use alloc::vec::Vec;
...
mod tests {
    ...
    use crate::i_overlay::core::overlay::{ContourDirection, IntOverlayOptions, Overlay};
    use crate::i_overlay::core::overlay_rule::OverlayRule;
    use crate::i_shape::int_shape;
