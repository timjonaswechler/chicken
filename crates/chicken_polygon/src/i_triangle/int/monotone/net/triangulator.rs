use crate::i_shape::util::reserve::Reserve;
use crate::i_triangle::geom::point::IndexPoint;
use crate::i_triangle::geom::triangle::IntTriangle;
use crate::i_float::triangle::Triangle;
use crate::i_tree::set::list::SetList;
use crate::i_tree::set::sort::SetCollection;
use crate::i_tree::set::tree::SetTree;
use crate::i_triangle::int::monotone::chain::builder::ChainVertexExport;
use crate::i_triangle::int::monotone::chain::vertex::{ChainVertex, VertexType};
use crate::i_triangle::int::monotone::net::phantom::{PhantomEdgePool, PhantomHandler};
use crate::i_triangle::int::monotone::net::section::{Content, EdgeType, Section, TriangleEdge};
use crate::i_triangle::int::monotone::v_segment::VSegment;
use crate::i_triangle::int::triangulation::RawIntTriangulation;
use alloc::vec;
use alloc::vec::Vec;
...
mod tests {
    ...
    use crate::i_overlay::core::overlay::IntOverlayOptions;
    use crate::i_overlay::core::simplify::Simplify;
    use crate::i_overlay::i_shape::int::area::Area;
    use crate::i_overlay::i_shape::int::path::IntPath;
    use crate::i_triangle::int::binder::SteinerInference;
    use crate::i_triangle::int::monotone::triangulator::MonotoneTriangulator;
    use crate::i_triangle::int::triangulation::RawIntTriangulation;
    use alloc::vec;
    use alloc::vec::Vec;
    use rand::Rng;
